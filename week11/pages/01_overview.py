...
st.caption("Bubble size = population | Color = continent")
...
# BBD CATEGORICAL colour type: distinct color palette per continent since continent is an unordered nominal variable.
fig = px.scatter(
    ...
    title=f'Wealthier nations live longer — but diminishing returns above $10,000 ({selected_year})', height=700
)
